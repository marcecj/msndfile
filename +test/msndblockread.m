...
[in_wav, fs] = wavread('test_files/test.wav');
...
in_blockwise(kk:end, :) = msndfile.blockread('read', 'test_files/test.wav', [kk file_size(1)]);
msndfile.blockread('close', 'test_files/test.wav');
...
msndfile.blockread('open', 'test_files/test.wav');
msndfile.blockread('open', 'test_files/test.flac');
msndfile.blockread('open', 'test_files/test.raw', file_info);
for kk = 1:block_size:file_size(1)-block_size
    in_blockwise1(kk:kk+block_size-1, :) = msndfile.blockread('read', 'test_files/test.wav', [kk kk+block_size-1]);
    in_blockwise2(kk:kk+block_size-1, :) = msndfile.blockread('read', 'test_files/test.flac', [kk kk+block_size-1]);
    in_blockwise3(kk:kk+block_size-1, :) = msndfile.blockread('read', 'test_files/test.raw', [kk kk+block_size-1]);
end
in_blockwise1(kk:end, :) = msndfile.blockread('read', 'test_files/test.wav', [kk file_size(1)]);
in_blockwise2(kk:end, :) = msndfile.blockread('read', 'test_files/test.flac', [kk file_size(1)]);
in_blockwise3(kk:end, :) = msndfile.blockread('read', 'test_files/test.raw', [kk file_size(1)]);
...
try
    ...
    msndfile.blockread('read', 'test_files/test.raw', [kk kk+block_size-1]);
...
try
    ...
    msndfile.blockread('read', 'test_files/test.wav', [kk kk+block_size-1]);
    warning('test:err', 'File not closed properly!');
catch ME
    disp('  ... error correctly raised.');
end
...
try
    ...
    msndfile.blockread('read', 'test_files/test.flac', [kk kk+block_size-1]);
    warning('test:err', 'File not closed properly!');
catch ME
    disp('  ... error correctly raised.');
end
...
in_blockwise1(kk+block_size:end, :) = msndfile.blockread('read', 'test_files/test.wav', file_size(1)-(kk+block_size)+1);
